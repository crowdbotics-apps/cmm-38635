"""
Django settings for cmm_38635 project.
...
WSGI_APPLICATION = 'cmm_38635.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cmm_38635 API",
    "DESCRIPTION": "API documentation for cmm_38635 App",
    "VERSION": "v1",
}
